...
authors: joshcena
tags: [前端, 个人网页]
image: /zh-Hans/img/blog/2021-03-09/docusaurus.png
---
...
<img src="/zh-Hans/img/blog/2021-03-09/page.jpg"></img>
...
2. 给网站选择一个主题色。我用了`#39cac4`，在[简介](/profile)中给出了原因。你可以用[这个工具](https://v2.docusaurus.io/docs/styling-layout#styling-your-site-with-infima)生成各种明暗色调，再把它们贴进`/src/css/custom.css`。
