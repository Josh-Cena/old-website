...
const CV: sections = [
  {
    ...
    items: [
      ...
      <Translate id="CV.sec1.item2" values={{ sup: <sup>rd</sup> }}>
        {"'20 BPhO top gold medalist, nationally ranked 3{sup}"}
      </Translate>,
      <Translate id="CV.sec1.item3" values={{ sup: <sup>th</sup> }}>
        {"'20 UKChO gold medalist, nationally ranked 7{sup}"}
      </Translate>,
      <Translate id="CV.sec1.item4">&apos;20 USABO gold medalist</Translate>,
      <Translate id="CV.sec1.item5">
        Solo-studied college CS &amp; chemistry courses
      </Translate>,
      <Translate
        id="CV.sec1.item6"
        values={{ link: <a href="https://www.qubitbyqubit.org/">QxQ</a> }}
      >
        {"IBM {link} courses on quantum computing"}
      </Translate>,
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      <Translate
        ...
        values={{
          link: (
            <a href="http://www.nsda.cn/home/PersonRank">
              <Translate id="CV.sec3.item1.link">nationally ranked</Translate>
            </a>
          ),
        }}
      >
      ...
      <Translate id="CV.sec3.item2">
        NSDA &apos;20 national champion in WSD format
      </Translate>,
      <Translate id="CV.sec3.item3">
        ...
        values={{
          link: (
            <a href="https://github.com/Computerization">
              <Translate id="CV.sec4.item1.link">Computerization</Translate>
            </a>
          ),
        }}
      >
        {"Current club leader of {link}"}
      </Translate>,
      <Translate
        id="CV.sec4.item2"
        values={{
          link: (
            <a href="https://github.com/Computerization/Enspire">Enspire</a>
          ),
        }}
      >
        {"Developer of {link}"}
  ...
  },
  {
    ...
    items: [
      ...
      <Translate
        id="CV.sec5.item2"
        values={{
          link: <a href="https://baterock-minecraft.github.io">BateRock</a>,
        }}
      >
        {"Operations and Tech manager of {link} server"}
      </Translate>,
      <Translate id="CV.sec5.item3">
        Built functional redstone CPU in Minecraft
      </Translate>,
      <Translate id="CV.sec5.item4">
