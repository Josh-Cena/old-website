    ...
    <Layout
      ...
      <header>
        ...
        <div className="text--center margin-top--md">
          <Link to="/blog/rss.xml" style={{ marginRight: 20 }} title="Feeds">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 124 124"
              ...
              <path
                d="M67,113.95c0,5.5,4.5,10,10,10s10-4.5,10-10c0-42.4-34.5-77-77-77c-5.5,0-10,4.5-10,10s4.5,10,10,10
                C41.5,56.95,67,82.55,67,113.95z"
              />
              <path
                d="M114,123.95c5.5,0,10-4.5,10-10c0-62.8-51.1-113.9-113.9-113.9c-5.5,0-10,4.5-10,10s4.5,10,10,10
                c51.8,0,93.9,42.1,93.9,93.9C104,119.45,108.4,123.95,114,123.95z"
              />
            </svg>
          </Link>
          <Link to="/blog/tags" style={{ marginRight: 22 }} title="Tags">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 512.0015 512"
              style={{ fill: "#39cac4" }}>
          ...
          <Link to="/blog/2021" title="archive">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 459.489 459.489"
              style={{ fill: "#39cac4" }}>
              <path
                d="M406.619,132.325H52.87c-8.284,0-15,6.716-15,15v286.513c0,8.284,6.716,15,15,15h353.749c8.284,0,15-6.716,15-15V147.325
                C421.619,139.041,414.903,132.325,406.619,132.325z M391.619,418.838H67.87V162.325h323.749V418.838z"
              />
              <path
                d="M444.489,10.651H15c-8.284,0-15,6.716-15,15v60.225c0,8.284,6.716,15,15,15h429.489c8.284,0,15-6.716,15-15V25.651
                C459.489,17.367,452.773,10.651,444.489,10.651z M429.489,70.876H30V40.651h399.489V70.876z"
              />
              <path
                d="M177.334,262.173h104.82c8.284,0,15-6.716,15-15v-43.562c0-8.284-6.716-15-15-15h-104.82c-8.284,0-15,6.716-15,15v43.562
