...
const features = [
  {
    title: <Translate id='front.features.feat1.title'>7-year programmer</Translate>,
  ...
  },
  {
    ...
    description: (
      <Translate
        ...
        values={{section: <code><Translate id='front.features.feat2.section'>docs</Translate></code>}}
      >
