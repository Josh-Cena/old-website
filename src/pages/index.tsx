...
function Feature({ sources, title, description, index }: feature & { index: number }) {
  return (
    <div className={clsx('col col--4', styles.feature)}>
      <div className="text--center">
        <ThemedImage className={styles.featureImage} sources={sources} alt={title} />
      </div>
      <h3>
    ...
    <Layout
      ...
      <CarouselProvider
        ...
        <div
          ...
          <ButtonBack
            id="back"
            className={clsx(styles.button, styles.carouselbutton, styles.backbutton)}
            style={{ visibility: buttonVisible ? 'visible' : 'hidden' }}>
            <FontAwesomeIcon icon={faChevronLeft} />
          </ButtonBack>
          <ButtonNext
            className={clsx(styles.button, styles.carouselbutton, styles.nextbutton)}
            style={{ visibility: buttonVisible ? 'visible' : 'hidden' }}>
